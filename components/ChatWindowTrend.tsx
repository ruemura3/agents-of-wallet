...
import { ChatMessageBubbleTrend } from "@/components/ChatMessageBubbleTrend";
import { UploadDocumentsForm } from "@/components/UploadDocumentsForm";
import { IntermediateStep } from "./IntermediateStep";

export function ChatWindowTrend(props: {
  endpoint: string;
  ...
  return (
    ...
    >
      <h2
        ...
        } text-2xl flex items-center gap-4`}
      >
        <img
